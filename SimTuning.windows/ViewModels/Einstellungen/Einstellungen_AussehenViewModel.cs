...
{
    public class Einstellungen_AussehenViewModel : SimTuning.ViewModels.Einstellungen.AussehenViewModel
    {
        private ApplicationChanges color = new ApplicationChanges();
        private MainWindowViewModel mainWindowViewModel;

        public Einstellungen_AussehenViewModel(MainWindowViewModel mainWindowViewModel)
        {
