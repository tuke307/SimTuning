        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CreatedDate = table.Column<DateTime>(nullable: false),
                    UpdatedDate = table.Column<DateTime>(nullable: false),
                    Hoehe = table.Column<double>(nullable: true),
                    Breite = table.Column<double>(nullable: true),
                    Flaeche = table.Column<double>(nullable: true),
                    SteuerzeitSZ = table.Column<double>(nullable: true),
            ...
            migrationBuilder.InsertData(
                table: "Settings",
                columns: new[] { "Id", "CreatedDate", "DarkMode", "Mail", "Password", "PrimaryColor", "SecondaryColor", "UpdatedDate" },
                values: new object[] { 1, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), false, null, null, "teal", "cyan", new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified) });
            ...
            migrationBuilder.InsertData(
                ...
                columns: new[] { "Id", "Anzahl", "Breite", "CreatedDate", "Flaeche", "Hoehe", "MotorId", "SteuerzeitSZ", "UpdatedDate" },
