...
namespace SimTuning.WPF.UI.Views.Dyno
{
    ...
    public partial class DynoAudioPlayerView : MvxWpfView<DynoAudioPlayerViewModel>
    {
        public DynoAudioPlayerView()
        {
            ...
            // if (!(ViewModel is DynoAudioPlayerViewModel)) { if
            // (Mvx.IoCProvider.TryResolve<DynoAudioPlayerViewModel>(out var
            // miniPlayerViewModel)) { ViewModel = miniPlayerViewModel; return; }
