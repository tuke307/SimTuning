// project=SimTuning.Core, file=TuningLogic.cs, creation=2020:7:31 Copyright (c) 2021 tuke
...
namespace SimTuning.Core.ModuleLogic
{
    public class TuningLogic
    {
        ...
        public PlotController Controller_tracker_on()
        {
            ...
            //plot_controller.BindMouseDown(OxyMouseButton.Left, OxyPlot.PlotCommands.HoverSnapTrack);
            //plot_controller.BindMouseDown(OxyMouseButton.Left, OxyPlot.PlotCommands.HoverPointsOnlyTrack);
        ...
        public void DefinePlot()
        {
            ...
            //Legende
            PlotTuning.LegendPosition = LegendPosition.RightTop;
        }
        ...
        public void TuningSeries()
        {
            ...
            //Punkte einfügen
            //for (int zaehler = 0; zaehler <= dataX2.GetUpperBound(0); zaehler++)
            //{
            //    tuningSeries.Points.Add(new DataPoint(dataX2[zaehler], dataY2[zaehler]));
            //}
