...
namespace SimTuning.Core
{
    ...
    {
        /// <summary> <summary> Gets a value indicating whether [license valid]. </summary> <value><c>true</c> if [license valid]; otherwise, <c>false</c>.</value>
        ...
        /// Gets a value indicating whether [user valid]. </summary> <value><c>true</c> if [user valid]; otherwise, <c>false</c>.</value>
