...
namespace SimTuning.Core.ViewModels.Motor
{
    ...
    public class UmrechnungViewModel : ViewModelBase
    {
        ...
        public UnitListItem DifferenceLengthUnit
        {
            ...
            set
            {
                this.DifferenceLength = Helpers.Functions.UpdateValue(this.DifferenceLength, this._differenceLengthUnit, value);
        ...
        public UnitListItem LengthDifferenceToOTUnit
        {
            ...
            set
            {
                this.LengthDifferenceToOT = Helpers.Functions.UpdateValue(this.LengthDifferenceToOT, this._lengthDifferenceToOTUnit, value);
        ...
        public UnitListItem UnitAbstandOTlength
        {
            ...
            set
            {
                this.LengthDifferenceToOT = Helpers.Functions.UpdateValue(this.LengthDifferenceToOT, this._unitAbstandOTlength, value);
        ...
        public UnitListItem VehicleMotorHubRUnit
        {
            ...
            set
            {
                this.VehicleMotorHubR = Helpers.Functions.UpdateValue(this.VehicleMotorHubR, this._vehicleMotorHubRUnit, value);
