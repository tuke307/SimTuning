// project=SimTuning.Core, file=TheorieViewModel.cs, creation=2020:7:31 Copyright (c) 2021
...
namespace SimTuning.Core.ViewModels.Auslass
{
    ...
    public class TheorieViewModel : MvxNavigationViewModel
    {
        ...
        public TheorieViewModel(ILoggerFactory logFactory, IMvxNavigationService navigationService)
