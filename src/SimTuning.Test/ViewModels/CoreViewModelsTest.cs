...
namespace SimTuning.Test
{
    ...
    [TestFixture]
    public class CoreViewModelsTest : MvxTest, IViewModelTest
    {
        /// <summary>
        ...
        {
            var vm = MvvmCross.IoC.MvxIoCProvider.Instance.IoCConstruct<SimTuning.Core.ViewModels.MainPageViewModel>();
        ...
        {
            var vm = MvvmCross.IoC.MvxIoCProvider.Instance.IoCConstruct<SimTuning.Core.ViewModels.MenuViewModel>();
        ...
        protected override void AdditionalSetup()
        {
            ...
            // for theme
            var themeService = new WPF.UI.Services.ThemeServiceBase();
